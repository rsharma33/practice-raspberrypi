...
<head>
    ...
    <link rel="stylesheet" href="<?php echo $cfg['baseurl']; ?>assets/css/lib/chosen/chosen.min.css">
...
<body>
    ...
    <script src="<?php echo $cfg['baseurl']; ?>assets/js/lib/chosen/chosen.jquery.min.js"></script>
